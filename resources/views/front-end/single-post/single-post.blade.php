            ...
            <div class="row">
                <div class="col-md-9 post-content" data-aos="fade-up">
                    ...
                    <div class="single-post">
                        ...
                        <figure class="my-4">
                            <img src="
{{asset('front-end-assets')}}/assets/img/post-landscape-1.jpg" alt="" class="img-fluid">
                        ...
                        <figure class="my-4">
                            <img src="
{{asset('front-end-assets')}}/assets/img/post-landscape-5.jpg" alt="" class="img-fluid">
                            <figcaption>Lorem ipsum dolor sit amet consectetur adipisicing elit. Explicabo, odit?
                            </figcaption>
                        </figure>
...
{{asset('front-end-assets')}}/assets/img/person-5.jpg" alt="" class="img-fluid">
                                </div>
                            </div>
                                ...
                                <div class="comment-replies bg-light p-3 mt-3 rounded">
                                    ...
                                    <div class="reply d-flex mb-4">
                                        <div class="flex-shrink-0">
                                            <div class="avatar avatar-sm rounded-circle">
                                                <img class="avatar-img" src="
{{asset('front-end-assets')}}/assets/img/person-4.jpg" alt="" class="img-fluid">
                                            </div>
                                        </div>
                                        <div class="flex-grow-1 ms-2 ms-sm-3">
                                    ...
                                    <div class="reply d-flex">
                                        <div class="flex-shrink-0">
                                            <div class="avatar avatar-sm rounded-circle">
                                                <img class="avatar-img" src="
{{asset('front-end-assets')}}/assets/img/person-3.jpg" alt="" class="img-fluid">
                                            </div>
                                        </div>
                                        <div class="flex-grow-1 ms-2 ms-sm-3">
                                            <div class="reply-meta d-flex align-items-baseline">
                        ...
                        <div class="comment d-flex">
                            <div class="flex-shrink-0">
                                <div class="avatar avatar-sm rounded-circle">
                                    <img class="avatar-img" src="
{{asset('front-end-assets')}}/assets/img/person-2.jpg" alt="" class="img-fluid">
                                </div>
                            </div>
